...
public class StatusServiceTableFontEnd {
	...
	/**
	 * @return the typeservices
	 */
	public String getTypeservices() {
		return typeservices;
	}
	/**
	 * @param typeservices the typeservices to set
	 */
	...
	/**
	 * @return the idcheckingoutroomdamaded
	 */
	public String getIdcheckingoutroomdamaded() {
		return idcheckingoutroomdamaded;
	}
	/**
	 * @param idcheckingoutroomdamaded the idcheckingoutroomdamaded to set
	 */
	...
	/**
	 * @return the detailservicesIdticketbooking
	 */
	public String getDetailservicesIdticketbooking() {
		return detailservicesIdticketbooking;
	}
	/**
	 * @param detailservicesIdticketbooking the detailservicesIdticketbooking to set
	 */
	...
	/**
	 * @return the detailservicesidproduct
	 */
	public String getDetailservicesidproduct() {
		return detailservicesidproduct;
	}
	/**
	 * @param detailservicesidproduct the detailservicesidproduct to set
	 */
