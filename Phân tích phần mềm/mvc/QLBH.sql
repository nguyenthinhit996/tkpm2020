...
GO
DBCC CHECKIDENT(N'[Categories]', RESEED, 33)
GO
...
GO
INSERT INTO [Categories] ([CatID], [CatName]) VALUES (N'1', N'Sách'), (N'2', N'Điện thoại'), (N'3', N'Máy chụp hình'), (N'4', N'Quần áo - Giày dép'), (N'5', N'Máy tính'), (N'6', N'Đồ trang sức'), (N'7', N'Khác')
GO
GO
...
BEGIN TRANSACTION
GO
INSERT INTO [OrderDetails] ([OrderID], [ProID], [Quantity], [Price], [Amount]) VALUES (N'1', N'1', N'2', N'1500000.0000', N'3000000.0000'), (N'1', N'2', N'2', N'300000.0000', N'600000.0000'), (N'2', N'1', N'1', N'1500000.0000', N'1500000.0000'), (N'2', N'2', N'1', N'300000.0000', N'300000.0000')
GO
GO
COMMIT TRANSACTION
GO
...
GO
DBCC CHECKIDENT(N'[Orders]', RESEED, 2)
GO
...
GO
INSERT INTO [Orders] ([OrderID], [OrderDate], [UserID], [Total]) VALUES (N'1', N'2014-03-14 00:00:00.000', N'5', N'3600000.0000'), (N'2', N'2014-03-14 00:00:00.000', N'5', N'1800000.0000')
GO
GO
...
GO
DBCC CHECKIDENT(N'[Products]', RESEED, 30)
GO
...
</UL>', N'1500000.0000', N'6', N'83'), (N'2', N'Pink Sapphire Sterling Silver', N'14 1/2 Carat Created Pink Sapphire Sterling Silver Bracelet w/ Diamond Accents', N'<P><STRONG>Jewelry Information</STRONG></P>
<UL>
    <LI>Loại hàng: Hàng trong nước</LI>
</UL>
', N'300000.0000', N'6', N'64'), (N'3', N'Torrini KC241', N'Nhẫn kim cương - vẻ đẹp kiêu sa', N'<P>Không chỉ có kiểu dáng truyền thống chỉ có một hạt kim cương ở giữa, các nhà thiết kế đã tạo những những chiếc nhẫn vô cùng độc đáo và tinh tế. Tuy nhiên, giá của đồ trang sức này thì chỉ có dân chơi mới có thể kham được.</P>
<UL>
...
', N'1600000000.0000', N'6', N'86'), (N'4', N'Torrini KC242', N'tinh xảo và sang trọng', N'<P>Để sở hữu một chiếc nhẫn kim cương lấp lánh trên tay, bạn phải là người chịu chi và sành điệu.<BR>
...
', N'42000000.0000', N'6', N'63'), (N'5', N'Nokia 7610', N'Độ phân giải cao, màn hình màu, chụp ảnh xuất sắc.', N'<UL>
...
', N'2900000.0000', N'2', N'0'), (N'6', N'Áo thun nữ', N'Màu sắc tươi tắn, kiểu dáng trẻ trung', N'<UL>
    <LI>Loại hàng: Hàng trong nước</LI>
    <LI>Xuất xứ: Tp Hồ Chí Minh</LI>
</UL>
', N'180000.0000', N'4', N'62'), (N'7', N'Simen AP75', N'Thiết kế tinh xảo, hiện đại', N'<UL>
...
', N'2800000.0000', N'2', N'15'), (N'8', N'Áo bé trai', N'Hóm hỉnh dễ thương', N'<UL>
    <LI>Quần áo bé trai</LI>
    <LI>Loại hàng: Hàng trong nước</LI>
    <LI>Xuất xứ: Tp Hồ Chí Minh</LI>
</UL>
', N'270000.0000', N'4', N'74'), (N'9', N'Bông tai nạm hạt rubby', N'Trẻ trung và quý phái', N'<UL>
...
', N'2400000.0000', N'6', N'43'), (N'10', N'Đầm dạ hội ánh kim', N'Đủ màu sắc - kiểu dáng', N'<UL>
...
', N'2800000.0000', N'4', N'80'), (N'11', N'Dây chuyền ánh bạc', N'Kiểu dáng mới lạ', N'<UL>
...
', N'250000.0000', N'6', N'88'), (N'12', N'Đồ bộ bé gái', N'Đủ màu sắc - kiểu dáng', N'<UL>
    <LI>Màu sắc: đỏ tía, xanh biển, vàng tím, trắng và đen.</LI>
    <LI>Xuất xứ: Tp. Hồ Chí Minh</LI>
    <LI>Chất liệu: cotton</LI>
    <LI>Loại hàng: hàng trong nước</LI>
</UL>
', N'120000.0000', N'4', N'61'), (N'13', N'Đầm dạ hội Xinh Xinh', N'Đơn giản nhưng quý phái', N'<P>Những đường cong tuyệt đẹp sẽ càng được phô bày khi diện các thiết kế này.</P>
<UL>
...
', N'2600000.0000', N'4', N'92'), (N'14', N'Đầm dạ hội NEM', N'Táo bạo và quyến rũ', N'<P>Những đường cong tuyệt đẹp sẽ càng được phô bày khi diện các thiết kế này.</P>
<UL>
    <LI>Nét cắt táo bạo ở ngực giúp bạn gái thêm phần quyến rũ, ngay cả khi không có trang&nbsp; sức nào trên người.</LI>
    <LI>Đầm hai dây thật điệu đà với nơ xinh trước ngực nhưng trông bạn vẫn toát lên vẻ tinh nghịch và bụi bặm nhờ thiết kế đầm bí độc đáo cùng sắc màu sẫm.</LI>
    <LI>Hãng sản xuất: NEM</LI>
...
', N'1200000.0000', N'4', N'0'), (N'15', N'Dây chuyền đá quý', N'Kết hợp vàng trắng và đá quý', N'<UL>
...
', N'1925000.0000', N'6', N'22'), (N'16', N'Nokia N72', N'Sành điệu cùng N72', N'<UL>
...
', N'3200000.0000', N'2', N'81'), (N'17', N'Mặt dây chuyền Ruby', N'Toả sáng cùng Ruby', N'<UL>
...
', N'1820000.0000', N'6', N'33'), (N'18', N'1/2 Carat Pink Sapphire Silver', N'Created Pink Sapphire', N'<UL>
...
', N'3400000.0000', N'6', N'10'), (N'19', N'Netaya', N'Dây chuyền vàng trắng', N'<UL>
    <LI>Kiểu sản phẩm:&nbsp; Dây chuyền</LI>
    <LI>Chất liệu: Vàng tây 18K, nguyên liệu và công nghệ Italy...</LI>
    <LI>Trọng lượng chất liệu: 1 Chỉ</LI>
</UL>
', N'1820000.0000', N'6', N'17'), (N'20', N'Giày nam GN16', N'Êm - đẹp - bền', N'<UL>
    <LI>Loại hàng: Hàng trong nước</LI>
    <LI>Xuất xứ: Tp Hồ Chí Minh</LI>
    <LI>Giá: 300 000 VNĐ</LI>
</UL>
', N'540000.0000', N'4', N'0'), (N'21', N'G3.370A', N'Đen bóng, sang trọng', N'<UL>
    <LI>Loại hàng: Hàng trong nước</LI>
    <LI>Xuất xứ: Tp Hồ Chí Minh</LI>
</UL>
', N'300000.0000', N'4', N'74'), (N'22', N'Giày nữ GN1', N'Kiểu dáng thanh thoát', N'<UL>
    <LI>Loại hàng: Hàng trong nước</LI>
    <LI>Xuất xứ: Tp Hồ Chí Minh</LI>
</UL>
', N'290000.0000', N'4', N'30'), (N'23', N'NV002', N'Kiểu dáng độc đáo', N'<P><STRONG>Thông tin sản phẩm</STRONG></P>
<UL>
    <LI>Mã sản phẩm: NV002</LI>
    <LI>Trọng lượng: 2 chỉ</LI>
    <LI>Vật liệu chính: Vàng 24K</LI>
</UL>
', N'3600000.0000', N'6', N'5'), (N'24', N'NV009', N'Sáng chói - mới lạ', N'<P><STRONG>Thông tin sản phẩm</STRONG></P>
<UL>
    <LI>Mã sản phẩm: NV005</LI>
    <LI>Trọng lượng: 1 cây</LI>
    <LI>Vật liệu chính: Vàng 24K</LI>
</UL>
', N'14900000.0000', N'6', N'22'), (N'25', N'CK010', N'Độc đáo, sang trọng', N'<UL>
...
', N'2400000000.0000', N'6', N'52'), (N'26', N'CK009', N'Nữ tính - đầy quí phái', N'<UL>
...
', N'1850000000.0000', N'6', N'11'), (N'27', N'CK007', N'Sự kết hợp khéo léo, độc đáo', N'<UL>
    <LI>Để sở hữu một chiếc nhẫn kim cương lấp lánh trên tay, bạn phải là người chịu chi và sành điệu.</LI>
    <LI>Với sự kết hợp khéo léo và độc đáo giữa kim cương và Saphia, Ruby... những chiếc nhẫn càng trở nên giá trị</LI>
    <LI>Nhà sản xuất: Torrini</LI>
</UL>
<P>Cái này rất phù hợp cho bạn khi tặng nàng</P>
', N'3100000000.0000', N'6', N'28'), (N'28', N'CK005', N'Tinh xảo - sang trọng', N'<UL>
...
', N'1800000000.0000', N'6', N'29'), (N'29', N'NV01TT', N'Tinh tế đến không ngờ', N'<UL>
    <LI>Tinh xảo và sang trọng</LI>
    <LI>Thông tin nhà sản xuất: Torrini</LI>
    <LI>Không chỉ có kiểu dáng truyền thống chỉ có một hạt kim cương ở giữa, các nhà thiết kế đã tạo những những chiếc nhẫn vô cùng độc đáo và tinh tế.</LI>
    <LI>Tuy nhiên, giá của đồ trang sức này thì chỉ có dân chơi mới có thể kham được</LI>
</UL>
', N'500000000.0000', N'6', N'49'), (N'30', N'Motorola W377', N'Nữ tính - trẻ trung', N'<UL>
...
GO
DBCC CHECKIDENT(N'[Users]', RESEED, 9)
GO
...
GO
INSERT INTO [Users] ([f_ID], [f_Username], [f_Password], [f_Name], [f_Email], [f_DOB], [f_Permission]) VALUES (N'5', N'nndkhoa', N'E0308DA5BBE8279ADC296567334D429B', N'Khoa N. D. Ngô', N'nndkhoa@a.c', N'2014-02-26 00:00:00.000', N'0'), (N'6', N'tdquang', N'BABA9830D1E5DEAE4954C1364B536D66', N'Trần Duy Quang', N'tdquang@a.c', N'2014-02-18 00:00:00.000', N'0'), (N'8', N'abc', N'E10ADC3949BA59ABBE56E057F20F883E', N'abc', N'abc@a.c', N'2014-03-07 00:00:00.000', N'0'), (N'9', N'admin', N'0192023A7BBD73250516F069DF18B500', N'Admin', N'admin@g.c', N'2014-03-19 00:00:00.000', N'1')
GO
GO
...
-- ----------------------------
ALTER TABLE [OrderDetails] ADD PRIMARY KEY ([OrderID], [ProID])
GO
...
-- ----------------------------
ALTER TABLE [Users] ADD PRIMARY KEY ([f_ID])
GO

-- ----------------------------
-- Foreign Key structure for table [OrderDetails]
-- ----------------------------
ALTER TABLE [OrderDetails] ADD FOREIGN KEY ([OrderID]) REFERENCES [Orders] ([OrderID]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [OrderDetails] ADD FOREIGN KEY ([ProID]) REFERENCES [Products] ([ProID]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO

-- ----------------------------
-- Foreign Key structure for table [Products]
-- ----------------------------
ALTER TABLE [Products] ADD FOREIGN KEY ([CatID]) REFERENCES [Categories] ([CatID]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
